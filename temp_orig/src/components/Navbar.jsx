    ...
    <nav className="absolute top-0 left-0 right-0 z-50 w-full bg-transparent border-none select-none animate-fade-down">
      <div className="max-w-7xl mx-auto px-6 h-auto pt-8 pb-3 lg:h-16 lg:py-3 flex items-center justify-between relative">
        ...
        <div className="hidden md:flex items-center">
          <a
            href="#trial"
            className="px-[24px] py-[10px] bg-black text-white font-medium text-[14px] uppercase tracking-widest transition-all duration-300 hover:bg-neutral-800 border border-black hover:px-7 active:scale-98"
          >
            Start Free Trial
          </a>
        </div>
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="md:hidden fixed inset-0 w-screen h-screen bg-white z-50 flex flex-col justify-between select-none"
          >
              ...
              <div className="flex-grow flex flex-col items-center justify-start pt-10 space-y-8 px-6">
                ...
                <div className="w-full pt-4 max-w-[280px]">
                  <a
                    href="#trial"
                    onClick={() => setIsOpen(false)}
                    className="w-full py-3 bg-black text-white font-semibold text-[14px] uppercase tracking-widest flex items-center justify-center space-x-2 border border-black hover:bg-neutral-800 transition-all"
                  >
